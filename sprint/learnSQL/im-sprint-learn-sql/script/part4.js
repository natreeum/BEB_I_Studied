...
*/
const PART4_3 = `INSERT INTO user (name, email) VALUES ('minseob', 'alstjq@cs.com')`;
...
*/
const PART4_10 = `INSERT INTO content (title, body, userId) VALUES ('페어님께 보내는 편지', '정연님 캐리해주셔서 감사합니다', 1)`;
